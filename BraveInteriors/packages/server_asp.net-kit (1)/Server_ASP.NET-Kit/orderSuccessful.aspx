<%@ Page Language="VB" AutoEventWireup="false" CodeFile="orderSuccessful.aspx.vb" Inherits="orderSuccessful" %>

<html>
<head runat="server">
	<title>Server ASP.Net Order Successful Page</title>
...
<div id="content">
    ...
    <p>The Server transaction has completed successfully and the customer has been returned to this order completion page<br>
	  <br>
